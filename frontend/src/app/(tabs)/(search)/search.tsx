...
export default function SearchScreen() {
  ...
  return (
    <ProgressiveBlurScreen title="Buscar">
...
function RecentSearches({
  ...
  const confirmClear = () => {
    Alert.alert(
      '¿Borrar las búsquedas?',
      'Al hacerlo, se eliminará tu historial de búsquedas de este dispositivo.',
      [
        { text: 'Cancelar', style: 'cancel' },
        { text: 'Borrar búsquedas', style: 'destructive', onPress: onClear },
      ],
    );
  };
